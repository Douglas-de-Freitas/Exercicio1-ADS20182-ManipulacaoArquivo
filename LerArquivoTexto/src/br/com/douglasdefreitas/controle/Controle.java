...
public class Controle {
	...
	// função tenta ler o arquivo e se tudo estiver ok ele cria a lista de acordo com o txt
	public static List<Aluno> criaERetornaListaDeAlunos() {
	...
	// tem o objetivo de ajustar a lista de alunos para impressão conforme pedido no exercicio
	// função retorna um texto ajustado conforme pedido
	public static String configuraImpressaoTextoDoRelatorio(int sequencia, int nDigitos, List<Aluno> alunos) {
